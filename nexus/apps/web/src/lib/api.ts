import type { Domain, Category, Platform, SocialChannel, Product, WorkflowRun } from '@nexus/types'
...
export const api = {
  ...
  // Products
  getProducts: (filters?: { status?: string; domain_id?: string; limit?: number }) => apiFetch<{ products: Product[] }>(`/api/products?${new URLSearchParams(filters as any)}`),
